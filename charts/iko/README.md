...
A Helm chart to deploy iko to Kubernetes
...
ingress:
  enabled: true
  hostname: iko.denhaag.nl

```

## Installing the Chart

To install the chart with the release name `iko`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install iko denhaag/iko
```

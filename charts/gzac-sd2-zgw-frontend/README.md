# gzac-sd2-zgw-frontend

A Helm chart to deploy gzac-sd2-zgw-frontend to Kubernetes
...
ingress:
  enabled: true
  hostname: gzac-sd2-zgw-frontend.denhaag.nl

```

## Installing the Chart

To install the chart with the release name `gzac-sd2-zgw-frontend`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install gzac-sd2-zgw-frontend denhaag/gzac-sd2-zgw-frontend
```

...
ingress:
  enabled: true
  hostname: gzac-sd2-zgw-backend.denhaag.nl

```

## Installing the Chart

To install the chart with the release name `gzac-sd2-zgw-backend`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install gzac-sd2-zgw-backend denhaag/gzac-sd2-zgw-backend
```

...
ingress:
  enabled: true
  hostname: smartdocuments-docengine.denhaag.nl

```

## Installing the Chart

To install the chart with the release name `smartdocuments-docengine`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install smartdocuments-docengine denhaag/smartdocuments-docengine
```

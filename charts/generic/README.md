...
To install the chart with the release name `generic`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install generic denhaag/generic
```
...
false
			...
			<td>Configure options for liveness probes.<br> Note: probes are disabled by default and have no checks defined.<br> ref: <a href="https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/#configure-probes">[link]</a></td>
		</tr>
		<tr>
...
false
			...
			<td>Configure options for readiness probes.<br> Note: probes are disabled by default and have no checks defined.<br> ref: <a href="https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/#configure-probes">[link]</a></td>
		</tr>
		<tr>
...
null
			...
			<td>Set the LoadBalancer service type to internal only.<br> ref: <a href="https://kubernetes.io/docs/concepts/services-networking/service/#internal-load-balancer">[link]</a></td>
		</tr>
		<tr>
...
[]
			...
			<td>Load Balancer sources.<br> ref: <a href="https://kubernetes.io/docs/tasks/access-application-cluster/configure-cloud-provider-firewall/#restrict-access-for-loadbalancer-service">[link]</a></td>
		</tr>
		<tr>
...
null
			...
			<td>Specify the nodePort value for the LoadBalancer and NodePort service types.<br> ref: <a href="https://kubernetes.io/docs/concepts/services-networking/service/#type-nodeport">[link]</a></td>
		</tr>
		<tr>
			<td>service.port</td>
			<td>string</td>
...
false
			...
			<td>Configure options for startup probe.<br> Note: probes are disabled by default and have no checks defined.<br> ref: <a href="https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/#configure-probes">[link]</a></td>
		</tr>
		<tr>

...
To install the chart with the release name `dh-nl-portal-frontend`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install dh-nl-portal-frontend denhaag/dh-nl-portal-frontend
```
...
"configmaps.yaml"
		...
		<tr>
			<td>configMaps."{{ include "app.fullname" . }}".data."config.js"</td>
			<td>string</td>
			<td><pre lang="json">
...
false
		...
		<tr>
			<td>global.keycloakUrl</td>
			<td>string</td>
			<td><pre lang="json">
"https://keycloak-zgw.test.denhaag.nl"
</pre>
</td>
			<td></td>
		</tr>
...
"tmpfs-1"
		...
		<tr>
			<td>volumes[0].configMap.name</td>
			<td>string</td>
			<td><pre lang="json">

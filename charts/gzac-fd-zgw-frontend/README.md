...
To install the chart with the release name `gzac-fd-zgw-frontend`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install gzac-fd-zgw-frontend denhaag/gzac-fd-zgw-frontend
```

...
To install the chart with the release name `gzac-alg-zgw-frontend`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install gzac-alg-zgw-frontend denhaag/gzac-alg-zgw-frontend
```

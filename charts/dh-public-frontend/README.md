...
A Helm chart to deploy dh-public-frontend to Kubernetes
...
ingress:
  enabled: true
  hostname: dh-public-frontend.denhaag.nl

```

## Installing the Chart

To install the chart with the release name `dh-public-frontend`:

```console
$ helm repo add denhaag https://gemeente-denhaag.github.io/helm-charts/
$ helm install dh-public-frontend denhaag/dh-public-frontend
```
...
| DenHaag | <jan.brekelmans@denhaag.nl> |  |
| DenHaag | <thijs.vanson@denhaag.nl> |  |
